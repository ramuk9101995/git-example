...
git checkout master -- for any other branch to naster branch 

git branch dev -- create a branch name as dev

git checkout dev --to go into the dev branch to work in dev branch

git log --graph --oneline ---for commit history in one line

git checkout master --come to master 
git merge dev --now dev merge to master

green current branch changes
blue other branch changes

git branch -d dev --for remove dev branch

git stash --untracked file temporary saved but deleted also
